...
<head>
    ...
    <style>
        ...
        .feedback-item {
            position: relative;
            padding-right: 50px;
            border-bottom: 2px solid #949494ff
...
<body>
        ...
        <div class="content-area">
            ...
            <div id="feedbackTab" class="tab-content active">
                ...
                <div class="container" id="feedbackContainer">
                    <div class="card">
                        <div class="card-header" style="color: #ff0019ff;">Negative Feedback (1-2 Stars)</div>
                        <div class="card-body">
                    ...
                    <div class="card"> 
                        <div class="card-header" style="color: #00c52eff;">Positive Feedback (3-5 Stars)</div>
                        <div class="card-body">
    ...
    <script>
        ...
        async function loadHistory() {
            ...
            try {
                ...
                if (data.success) {
                    ...
                    // Complete the feedback.php JavaScript section
        ...
        function renderHistory(history) {
            ...
            tbody.innerHTML = history.map(h => `
                <tr>
                    ...
                    <td>
                        <span class="action-badge action-${h.action_type}">
                    ...
                    <td>${'⭐'.repeat(parseInt(h.rating))}</td>
                    <td style="white-space: nowrap;">
                        ${new Date(h.original_date).toLocaleDateString()}
                    </td>
                    <td>${h.deleted_by || 'N/A'}</td>
        ...
        function printFeedback() {
            ...
            document.getElementById('printPeriod').textContent = 'Period: ' + monthName;
